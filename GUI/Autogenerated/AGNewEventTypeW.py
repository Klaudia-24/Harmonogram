...
class Ui_NewEventTypeWindow(object):
    def setupUi(self, NewEventTypeWindow):
        ...
        NewEventTypeWindow.resize(606, 342)
        ...
        self.colorsPaletteButton.setMinimumSize(QtCore.QSize(100, 70))
        self.colorsPaletteButton.setMaximumSize(QtCore.QSize(100, 70))
        ...
        self.setEventColorButton.setMinimumSize(QtCore.QSize(100, 80))
        self.setEventColorButton.setMaximumSize(QtCore.QSize(16777215, 80))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.setEventColorButton.setFont(font)
        self.setEventColorButton.setStyleSheet("background-color: rgb(128, 159, 255);")
    ...
    def retranslateUi(self, NewEventTypeWindow):
        ...
        self.colorsPaletteButton.setText(_translate("NewEventTypeWindow", "Palette"))
