...
class Ui_NewEventWindow(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.window = QtWidgets.QLabel("This is a new window")
        ...
        # self.setDurationEventRadioButton = QtWidgets.QRadioButton(self.centralwidget)
        # font = QtGui.QFont()
        # font.setPointSize(14)
        ...
        # self.timeFromEdit = QtWidgets.QTimeEdit(self.centralwidget)
        ...
        # self.timeToEdit = QtWidgets.QTimeEdit(self.centralwidget)
        ...
        # self.cancelButton.clicked.connect(self.hideWinow)
    ...
    def init_ui(self):
        self.cancel.clicked.connect(self.hideWinow)
    ...
    def retranslateUi(self, NewEventWindow):
        ...
        self.setDurationEventRadioButton.setText(_translate("NewEventWindow", "Set duration"))
