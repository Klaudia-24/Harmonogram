...
class Ui_NewEventWindow(object):
    def setupUi(self, NewEventWindow):
        ...
        NewEventWindow.resize(500, 745)
        NewEventWindow.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.allDayEventRadioButton = QtWidgets.QRadioButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.fromTimeEdit.setMinimumSize(QtCore.QSize(120, 30))
        self.fromTimeEdit.setMaximumSize(QtCore.QSize(100, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.fromTimeEdit.setFont(font)
        self.fromTimeEdit.setObjectName("fromTimeEdit")
        self.horizontalLayout_9.addWidget(self.fromTimeEdit)
        ...
        self.toLabel.setMinimumSize(QtCore.QSize(80, 0))
        ...
        self.toTimeEdit = QtWidgets.QTimeEdit(self.centralwidget)
        self.toTimeEdit.setMinimumSize(QtCore.QSize(120, 30))
        self.toTimeEdit.setMaximumSize(QtCore.QSize(100, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.toTimeEdit.setFont(font)
        self.toTimeEdit.setDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 1), QtCore.QTime(1, 0, 0)))
        self.toTimeEdit.setObjectName("toTimeEdit")
        self.horizontalLayout_7.addWidget(self.toTimeEdit)
        ...
        self.eventTypeLabel = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        ...
        self.eventTypeComboBox = QtWidgets.QComboBox(self.centralwidget)
        ...
        self.addEventTypeButton = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.eventTitlePlainTextEdit = QtWidgets.QPlainTextEdit(self.centralwidget)
        ...
        self.eventDescriptionPlaneTextEdit = QtWidgets.QPlainTextEdit(self.centralwidget)
        ...
        self.localizationLabel = QtWidgets.QLabel(self.centralwidget)
        ...
        self.eventLocalizationPlainTextEdit = QtWidgets.QPlainTextEdit(self.centralwidget)
        ...
        self.remindLabel = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.remindBeforeComboBox = QtWidgets.QComboBox(self.centralwidget)
        self.remindBeforeComboBox.setMaximumSize(QtCore.QSize(300, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.beforeEventLabel = QtWidgets.QLabel(self.centralwidget)
    ...
    def retranslateUi(self, NewEventWindow):
        ...
        NewEventWindow.setWindowTitle(_translate("NewEventWindow", "New Event"))
        self.dateLabel.setText(_translate("NewEventWindow", "Date"))
        self.allDayEventRadioButton.setText(_translate("NewEventWindow", "All day event"))
        self.fromLabel.setText(_translate("NewEventWindow", "From: "))
        self.toLabel.setText(_translate("NewEventWindow", "To: "))
        self.eventTypeLabel.setText(_translate("NewEventWindow", "Event type"))
        self.addEventTypeButton.setText(_translate("NewEventWindow", "Add new type"))
        self.titleLabel.setText(_translate("NewEventWindow", "Title"))
        self.descriptionLabel.setText(_translate("NewEventWindow", "Description"))
        self.localizationLabel.setText(_translate("NewEventWindow", "Localization"))
